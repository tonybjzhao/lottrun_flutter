...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get lotteryFranceLoto => 'Loto';
  ...
  @override
  String get bonusChanceNumber => 'Numéro Chance';
  ...
  @override
  String get settingsNotificationTime => 'Heure de notification';

  @override
  String settingsNotificationTimeSubtitle(Object time) {
    return 'Les aperçus quotidiens et hebdomadaires sont programmés pour $time.';
  }
  ...
  String get settingsAnalysisStyleSubtitle =>
      'Comment les tendances historiques sont pondérées';

  @override
  String get analysisStyleRecentTrend => 'Tendance récente';

  @override
  String get analysisStyleRecentTrendDescription =>
      'Met l\'accent sur les motifs récents (0-12 semaines : 70%, 13-52 semaines : 20%, 1-5 ans : 10%)';

  @override
  String get analysisStyleBalanced => 'Équilibré';

  @override
  String get analysisStyleBalancedDescription =>
      'Considération égale sur toutes les périodes (0-12 semaines : 50%, 13-52 semaines : 30%, 1-5 ans : 20%)';

  @override
  String get analysisStyleLongTermPattern => 'Motif à long terme';

  @override
  String get analysisStyleLongTermPatternDescription =>
      'Met l\'accent sur les motifs historiques (0-12 semaines : 30%, 13-52 semaines : 30%, 1-5 ans : 40%)';

  @override
  String get analysisStyleDisclaimer =>
      'Cela change uniquement la pondération des tendances historiques. Cela n\'améliore pas les chances de gagner.';
  ...
  String dailyInsightStrongDynamic(
    ...
    return '$lotteryName : sur les $drawCount derniers tirages, les numéros les plus actifs sont $hotNumbers.';
  }
  ...
  String dailyInsightMidRangeDynamic(
    ...
    return '$lotteryName : les $drawCount derniers tirages montrent plus d’activité au milieu de la plage. Numéros actifs : $hotNumbers.';
  }
  ...
  String dailyInsightHigherRangeDynamic(
    ...
    return '$lotteryName : les $drawCount derniers tirages penchent vers les numéros élevés, avec une somme moyenne de $averageSum.';
  }
  ...
  String dailyInsightLowerRangeDynamic(
    ...
    return '$lotteryName : les $drawCount derniers tirages penchent vers les numéros bas, avec une somme moyenne de $averageSum.';
  }
  ...
  String dailyInsightBalancedDynamic(
    ...
    return '$lotteryName : les $drawCount derniers tirages sont équilibrés. Numéros actifs : $hotNumbers ; structure courante : $oddEvenPattern.';
  }
  ...
  String dailyInsightNoTrendDynamic(
    ...
    return '$lotteryName : aucun motif fort dans les $drawCount derniers tirages. Structure courante : $oddEvenPattern.';
  }
  ...
  String weeklySummaryStrongDynamic(
    ...
    return '$lotteryName : résumé hebdomadaire basé sur les $drawCount derniers tirages. Numéros chauds : $hotNumbers ; structure courante : $oddEvenPattern.';
  }
  ...
  String weeklySummaryBalancedDynamic(
    ...
    return '$lotteryName : résumé hebdomadaire basé sur les $drawCount derniers tirages. Numéros chauds : $hotNumbers ; plage : $lowHighPattern.';
  }
  ...
  String weeklySummaryNoTrendDynamic(
    ...
    return '$lotteryName : le résumé hebdomadaire des $drawCount derniers tirages ne montre pas de tendance forte. Structure : $oddEvenPattern ; plage : $lowHighPattern.';
  }
  ...
  @override
  String get completeMyNumbers => 'Compléter mes numéros';

  @override
  String get completeMyNumbersTitle => 'Verrouiller vos numéros porte-bonheur';

  @override
  String get completeMyNumbersSubtitle =>
      'Sélectionnez les numéros que vous souhaitez conserver et nous générerons le reste selon votre stratégie.';

  @override
  String get selectYourNumbers => 'Vos numéros';

  @override
  String tapToLockNumbers(int locked, int total) {
    return 'Appuyez pour verrouiller ($locked/$total)';
  }

  @override
  String get bonusNumbers => 'Numéros bonus';

  @override
  String tapToLockBonusNumbers(int locked, int total) {
    return 'Appuyez pour verrouiller bonus ($locked/$total)';
  }

  @override
  String get generationStrategy => 'Stratégie de génération';

  @override
  String get generateAllNumbers => 'Générer des numéros';

  @override
  String get completeRemainingNumbers => 'Compléter mes numéros';

  @override
  String get yourCompletedNumbers => 'Vos numéros complets';

  @override
  String get locked => 'Vos choix';
  ...
  String maxNumbersSelected(int max) {
    return 'Maximum $max numéros autorisés';
  }
  ...
  @override
  String get regenerate => 'Réessayer';
