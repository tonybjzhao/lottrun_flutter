...
class _FireTemplate extends StatelessWidget {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    PlatformText.t('🔥 So close!', '🔥 Near match!'),
                    style: const TextStyle(
                      color: Colors.white,
                      fontSize: 24,
  ...
  Widget _topBar() => Row(children: [
        ...
        Container(
          ...
          child: Text(PlatformText.t('LottoRun AI', 'NumberRun'),
              style: const TextStyle(
  ...
  Widget _footer() => Text(
        PlatformText.t('✨ LottoRun AI', '✨ NumberRun'),
        textAlign: TextAlign.center,
        style: const TextStyle(
...
class _ElectricTemplate extends StatelessWidget {
  ...
  Widget _topBar() => Row(children: [
        ...
        const Spacer(),
        Text(PlatformText.t('✨ LottoRun AI', '✨ NumberRun'),
            style: const TextStyle(
                color: Color(0x99FFFFFF),
                fontSize: 10,
                fontWeight: FontWeight.w600)),
...
class _WarmTemplate extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isFunnyFail) {
      emoji    = '😂';
      headline = 'Not today';
      subhead  = isMiss ? '0 matched' : PlatformText.t('Funny fail energy', 'Random result');
      blurbText = null;
    } else if (isPending) {
      emoji    = '⏳';
      headline = 'Draw day incoming!';
      subhead  = PlatformText.t('Fingers crossed 🤞', 'Waiting for results 🤞');
      blurbText = 'Can you beat this? 👀';
    } else {
      emoji    = '🎯';
      headline = PlatformText.t('My Lucky Pick', 'My Number Pick');
...
Future<void> sharePickCards({
  ...
  try {
    ...
    await Share.shareXFiles(
      files,
      text: PlatformText.t('My AI lottery picks 🎯 — Generated by LottoRun AI', 'My number picks 🎯 — Generated by NumberRun'),
      sharePositionOrigin: origin,
    );
  } catch (e) {
...
String _shareText(PickMatchResult? result, Lottery? lottery) {
  if (result == null || result.isPending) {
    return PlatformText.t('My AI lottery pick 🎯 — Generated by LottoRun AI', 'My number pick 🎯 — Generated by NumberRun');
  }
  ...
  return switch (tmpl) {
    ShareCardTemplate.fire     => PlatformText.t('🔥 SO CLOSE! Check my LottoRun AI lottery pick!', '🔥 Number comparison from NumberRun'),
    ShareCardTemplate.electric => PlatformText.t('🎯 Nice hit! Check my LottoRun AI lottery pick!', '🎯 Number match from NumberRun'),
    ShareCardTemplate.warm     => total == 0
        ? PlatformText.t('😆 Better luck next time! My AI lottery pick — LottoRun AI', '😆 Random result from NumberRun')
        : PlatformText.t('My AI lottery pick 🎯 — Generated by LottoRun AI', 'My number pick 🎯 — Generated by NumberRun'),
  };
}

String _templateLabel(ShareCardTemplate template) => switch (template) {
      ShareCardTemplate.fire => PlatformText.t('🔥 Almost Win', '🔥 Almost Match'),
      ShareCardTemplate.electric => PlatformText.t('🎯 Good Hit', '🎯 Number Match'),
      ShareCardTemplate.warm => PlatformText.t('😂 Funny Fail', '😂 Random Result'),
    };
